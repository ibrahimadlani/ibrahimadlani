...
const Projects = () => {
  return (
    <section id="projects" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="Selected projects">
      ...
      <h2 className="text-sm font-bold uppercase tracking-widest text-primary ">Projects</h2>
      </div>
      <div>
        ...
        <div className="mt-12">
          <a className="inline-flex items-center font-medium leading-tight text-primary font-semibold text-primary group" aria-label="View All GitHub Project" target='_blank' href="https://github.com/ibrahimadlani?tab=repositories">
            <span>
              <span className="border-b border-transparent pb-px transition group-hover:border-accent motion-reduce:transition-none">View All GitHub </span>
              <span className="whitespace-nowrap">
                <span className="border-b border-transparent pb-px transition group-hover:border-accent motion-reduce:transition-none">Projects</span>
